...
针对任务三，我们完成了yolo模型的训练，成功识别了寝室的门把手，其中，对于测试集的识别效果以.jpg格式保存在code中val_batch0_pred.jpg,val_batch1_pred.jpg,val_batch2_pred.jpg，源代码保存在train.py中，模型为best.pt,加入卡尔曼滤波的版本保存在track_with_kalman.py中，效果视频保存在1f221627607e6617f86b1894c2e5552e.mp4。
